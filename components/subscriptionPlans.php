    ...
    <div class="card card--purple">
      <div class="card__outer">
        <div class="card__inner">
          ...
          <p class="title">Pack débutant</p>
          <p class="price"><span class="price price--number">3000 DHS</span></p>
    ...
    <div class="card card--red active">
      <div class="card__outer">
        <div class="card__inner">
          ...
          <p class="title">Pack athlète</p>
          <p class="price"><span class="price price--number">4500 DHS</span></p>
    ...
    <div class="card card--green">
      <div class="card__outer">
        <div class="card__inner">
          ...
          <p class="title">Pack premium </p>
          <p class="price"><span class="price price--number">7000 DHS</span></p>
